...
import { Image, StyleSheet, SafeAreaView, Dimensions, View, TextInput, ScrollView} from 'react-native';
...
export default class Chaimager_adder extends Component {
    ...
    add_chaimager = async () => {
        ...
        this.setState(() => { return { chaimager_adder_popup_visible: true }})
    }
        ...
        return (
            <SafeAreaView style={{ flex: 1 }}>
                ...
                <View style={{flex: 1, flexDirection:'row', alignSelf:'center'}}> 
                    <Button onPress={this.add_chaimager} style={{marginTop:10, height:Dimensions.get('window').height / 12}}>Add character</Button>
